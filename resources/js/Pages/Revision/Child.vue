...
<template>
  <div
    ...
    <div ref="container" class="flex-none flex items-center rounded-md" :draggable="false">
      <Icon v-if="procedure.parent_id" src="arrow-left" @click.prevent="left" class="px-2 py-1 bg-slate-100 hover:bg-slate-50 border border-slate-300 transition-all cursor-pointer" />
      <Icon v-if="procedure.position > 1" src="arrow-right" @click.prevent="right" class="px-2 py-1 bg-slate-100 hover:bg-slate-50 border border-slate-300 transition-all cursor-pointer" />
      <Icon v-if="procedure.position > 1" src="arrow-up" @click.prevent="up" class="px-2 py-1 bg-slate-100 hover:bg-slate-50 border border-slate-300 transition-all cursor-pointer" />
      <Icon v-if="procedure.parent?.childs_count !== procedure.position" src="arrow-down" @click.prevent="down" class="px-2 py-1 bg-slate-100 hover:bg-slate-50 border border-slate-300 transition-all cursor-pointer" />
      <Icon @click.prevent="edit(procedure)" src="edit" class="px-2 py-1 bg-blue-600 hover:bg-blue-700 border border-blue-600 hover:border-blue-700 transition-all cursor-pointer text-white" />
